...
class Menu {
  ...
  void addUser() {
    try {
      ...
      stdout.write('Acsess level (A - Admin, T - Teacher, S - Student): ');
      ...
      stdout.write('Add user to BD (S - SUAI, U - Unecon): ');
      ...
      switch (type.toUpperCase()) {
        ...
        default:
          print('Error (incorrect DB). Exit programm');
          return;
      }
    } catch (e) {
  ...
  void removeUser() {
    stdout.write('Remove user on DB (S - SUAI, U - Unecon): ');
    var type = stdin.readLineSync()!;
    late DBType typeDB;
    switch (type.toUpperCase()) {
      case 'S':
